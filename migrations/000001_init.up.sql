...
CREATE SCHEMA printshop_provider_accounts AUTHORIZATION user_pg;

-- --------------------------------------------------------------------------------------------------

CREATE TABLE printshop_provider_accounts.companies_pages (
    ...
    datetime_status timestamp with time zone NOT NULL DEFAULT now()
);
...
INSERT INTO printshop_controls.element_templates (template_id, tag_version, created_at, updated_at, param_name, template_caption, element_type, element_detailing, element_body, template_status)
...
INSERT INTO printshop_controls.submit_forms (form_id, tag_version, created_at, updated_at, rewrite_name, param_name, form_caption, form_detailing, form_status)
VALUES ('aa22434f-f09d-4b20-89c0-0785948cdc04', 1, '2023-07-03 19:33:28.945816', NULL, 'flyers-001', 'Flyers', 'Флаеры', 1/*NORMAL*/, 2/*ENABLED*/);
...
INSERT INTO printshop_controls.submit_form_elements (element_id, tag_version, created_at, updated_at, form_id, param_name, element_caption, template_id, template_version, element_required, prev_field_id, next_field_id, order_index)
VALUES (1, 1, '2023-07-15 13:49:58.567032', NULL, 'aa22434f-f09d-4b20-89c0-0785948cdc04', 'Product', 'Поля листовой продукции', 1, 1, true, null, null, 1048576);
...
INSERT INTO printshop_controls.submit_forms_compiled (form_id, version, created_at, updated_at, rewrite_name, form_caption, form_detailing, body_compiled, activity_status)
VALUES ('aa22434f-f09d-4b20-89c0-0785948cdc04', 1, '2023-07-03 19:33:28.945816', NULL, 'flyers-001', 'Флаеры', 1/*NORMAL*/, '[]', 2/*PUBLISHED*/),
       ('aa22434f-f09d-4b20-89c0-0785948cdc04', 2, '2023-07-03 19:33:28.945816', NULL, 'flyers-001', 'Флаеры', 1/*NORMAL*/, '[]', 1/*TESTING*/);
...
INSERT INTO printshop_dictionaries.laminate_types (type_id, tag_version, created_at, updated_at, type_caption, type_status)
VALUES
...
INSERT INTO printshop_dictionaries.paper_colors (color_id, tag_version, created_at, updated_at, color_caption, color_status)
VALUES
...
INSERT INTO printshop_dictionaries.paper_factures (facture_id, tag_version, created_at, updated_at, facture_caption, facture_status)
VALUES
...
INSERT INTO printshop_dictionaries.print_formats (format_id, tag_version, created_at, updated_at, format_caption, format_length, format_width, format_status)
VALUES
...
INSERT INTO printshop_catalog.boxes (box_id, tag_version, created_at, updated_at, box_article, box_caption, box_length, box_width, box_depth, box_status)
VALUES
...
INSERT INTO printshop_catalog.laminates (laminate_id, tag_version, created_at, updated_at, laminate_article, laminate_caption, type_id, laminate_length, laminate_weight, laminate_thickness, laminate_status)
VALUES
...
INSERT INTO printshop_catalog.papers (paper_id, tag_version, created_at, updated_at, paper_article, paper_caption, color_id, facture_id, paper_length, paper_width, paper_density, paper_thickness, paper_sides, paper_status)
VALUES
