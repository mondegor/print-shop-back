...
CREATE TABLE printshop_controls.submit_forms (
    form_id int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT pk_submit_forms PRIMARY KEY,
    tag_version int4 NOT NULL DEFAULT 1 CHECK(tag_version > 0),
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    updated_at timestamp with time zone NULL,
...
INSERT INTO printshop_controls.submit_forms (form_id, tag_version, created_at, updated_at, param_name, form_caption, form_detailing, form_body_compiled, form_status)
VALUES (1, 1, '2023-07-03 19:33:28.945816', NULL, 'Flyers', 'Флаеры', 1/*NORMAL*/, '[]', 2/*ENABLED*/);

ALTER SEQUENCE printshop_controls.submit_forms_form_id_seq RESTART WITH 2;
...
CREATE TABLE printshop_controls.submit_form_elements (
    ...
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    updated_at timestamp with time zone NULL,
    form_id int4 NOT NULL CONSTRAINT FK_submit_form_elements_form_id REFERENCES printshop_controls.submit_forms(form_id) ON DELETE CASCADE,
    param_name character varying(32) NULL,
...
INSERT INTO printshop_controls.submit_form_elements (element_id, tag_version, created_at, updated_at, form_id, param_name, element_caption, template_id, element_required, prev_field_id, next_field_id, order_index)
