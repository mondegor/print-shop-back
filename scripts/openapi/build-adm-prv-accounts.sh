...
mrcmd_func_openapi_build_adm_prv_accounts() {
  local sectionDir="${1:?}" # sample: .../admin-api, .../public-api
  local sharedDir="${2:?}" # sample: .../_shared

  local providerAccountsDir="${sectionDir}/provider-accounts"
  local companyPageDir="${providerAccountsDir}/company-page"

  # OPENAPI_VERSION="3.0.3"

  OPENAPI_HEADERS=(
    "${providerAccountsDir}/header.yaml"
