...
#  )
  ...
  OPENAPI_COMPONENTS_PARAMETERS=(
    ...
    "${sharedDir}/custom/parameters/Custom.Request.Query.Filter.PaperColorIDs.yaml"
    "${sharedDir}/custom/parameters/Custom.Request.Query.Filter.PaperFactureIDs.yaml"
