...
type (
	...
	Paper struct { // DB: printshop_catalog.papers
		...
		Length     measure.Micrometer     `json:"length" sort:"length" upd:"paper_length"`    // mkm (mm * 1000)
		Height     measure.Micrometer     `json:"height" sort:"height" upd:"paper_height"`    // mkm (mm * 1000)
		Thickness  measure.Micrometer     `json:"thickness" upd:"paper_thickness"`            // mkm (mm * 1000)
