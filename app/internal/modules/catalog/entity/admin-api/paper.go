...
import (
	entity_shared "print-shop-back/internal/modules/catalog/entity/shared"
...
type (
	Paper struct { // DB: ps_catalog.papers
		...
		ColorID   mrtype.KeyInt32         `json:"colorId" upd:"color_id"`                     // ps_dictionaries.paper_colors::color_id
		FactureID mrtype.KeyInt32         `json:"factureId" upd:"facture_id"`                 // ps_dictionaries.paper_factures::facture_id
