...
type (
	Paper struct { // DB: printdata_catalog.papers
		...
		ColorID   mrtype.KeyInt32         `json:"colorId" upd:"color_id"`                     // printdata_dictionaries.paper_colors::color_id
		FactureID mrtype.KeyInt32         `json:"factureId" upd:"facture_id"`                 // printdata_dictionaries.paper_factures::facture_id
