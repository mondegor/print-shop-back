...
func (uc *CatalogBox) GetList(ctx context.Context, listFilter *entity.CatalogBoxListFilter) ([]entity.CatalogBox, error) {
    ...
    if err != nil {
        return nil, mrcore.FactoryErrServiceTemporarilyUnavailable.Wrap(err, entity.ModelNameCatalogBox)
    }
...
func (uc *CatalogBox) checkArticle(ctx context.Context, item *entity.CatalogBox) error {
    ...
    if err != nil {
        ...
        return mrcore.FactoryErrServiceTemporarilyUnavailable.Wrap(err, entity.ModelNameCatalogBox)
    }
