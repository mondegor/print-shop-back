...
type (
	...
	PaperFactureUseCase interface {
		GetList(ctx context.Context, params entity.PaperFactureParams) (items []entity.PaperFacture, countItems int, err error)
		...
		Save(ctx context.Context, item entity.PaperFacture) error
