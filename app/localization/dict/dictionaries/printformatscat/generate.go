...
//go:generate gotext -srclang=en-US update -out=../../../../internal/localization/dict/dictionaries/printformatscat/catalog.go -lang=en-US,ru-RU print-shop-back/localization/dict/dictionaries/printformatscat
