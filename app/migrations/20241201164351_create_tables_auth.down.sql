...
DROP TABLE printshop_auth.users_activity_stat;
DROP TABLE printshop_auth.users_auth_2fa;
DROP TABLE printshop_auth.users_realms;
DROP TABLE printshop_auth.users;
