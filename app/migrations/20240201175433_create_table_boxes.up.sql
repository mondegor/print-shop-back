...
CREATE TABLE printshop_catalog.boxes (
    box_id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT pk_boxes PRIMARY KEY,
...
VALUES
    (1, 1, 'T-21-310x260x380', 'СДЭК', 0.310, 0.260, 0.380, 0.002, 1, 2/*ENABLED*/, '2023-07-28 19:47:00.917593', '2023-07-28 19:47:00.917593', NULL),
    (2, 1, 'T-23-300x300x300', 'СДЭК', 0.300, 0.300, 0.300, 0.002, 15.160, 2/*ENABLED*/, '2023-07-28 19:49:04.261215', '2023-07-28 19:49:04.261215', NULL),
    (3, 1, 'T-23-310x230x195', 'СДЭК', 0.310, 0.230, 0.195, 0.002, 7.400, 2/*ENABLED*/, '2023-07-30 12:28:57.095098', '2023-07-30 12:28:57.095098', NULL);
