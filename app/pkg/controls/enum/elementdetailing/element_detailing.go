...
// Возможные типы детализации элемента.
const (
	Normal   Enum = iota + 1 // обычная детализация
	Extended                 // расширенная детализация
)

const (
	enumLast = uint8(Extended)
	enumName = "ElementDetailing"
)
