...
// Возможные статусы публикации страницы.
const (
	Draft           Enum = iota + 1 // черновик
	Hidden                          // скрытый для всех пользователей
	Published                       // опубликован
	PublishedShared                 // опубликован и присутствует в каталоге
)

const (
	enumLast = uint8(PublishedShared)
	enumName = "PublicStatus"
)
...
var (
	...
	enumValues = map[string]Enum{
		...
		"HIDDEN":           Hidden,
		"PUBLISHED":        Published,
		"PUBLISHED_SHARED": PublishedShared,
	}
)
